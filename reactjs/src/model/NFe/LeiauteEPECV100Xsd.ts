import {TAmb,TCnpjOpc,TCpf,TChNFe,TDateTimeUTC,TCnpj,TVerAplic,TStat,TMotivo,TProt,TCodUfIBGE,TUf,TDec_1302} from "./TiposBasicoV103Xsd";
...
this._Id=value } } export class TEvento_InfEvento_DetEvento { _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _dest ; get dest ( ) { return this._dest; } set dest ( value : TEvento_InfEvento_DetEvento_Dest ) { this._dest=value } _versao ; get versao ( ) { return this._versao; } set versao ( value : any ) { validate(value,{"whiteSpace":"preserve","enumeration":["1.00"]});
this._versao=value } } export class TEvento_InfEvento_DetEvento_Dest { _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _CNPJ ; get CNPJ ( ) { return this._CNPJ; } set CNPJ ( value : any ) { TCnpj(value);
this._CNPJ=value
 } _CPF ; get CPF ( ) { return this._CPF; } set CPF ( value : any ) { TCpf(value);
this._CPF=value
...
this._idEstrangeiro=value } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } } export class TRetEvento { _infEvento ; get infEvento ( ) { return this._infEvento; } set infEvento ( value : TRetEvento_InfEvento ) { this._infEvento=value } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _versao ; get versao ( ) { return this._versao; } set versao ( value : any ) { undefined } } export class TRetEvento_InfEvento { _tpAmb ; get tpAmb ( ) { return this._tpAmb; } set tpAmb ( value : any ) { TAmb(value);
this._tpAmb=value
...
this._nSeqEvento=value } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _dhRegEvento ; get dhRegEvento ( ) { return this._dhRegEvento; } set dhRegEvento ( value : any ) { validate(value,{"whiteSpace":"preserve","pattern":"(((20(([02468][048])|([13579][26]))-02-29))|(20[0-9][0-9])-((((0[1-9])|(1[0-2]))-((0[1-9])|(1\\d)|(2[0-8])))|((((0[13578])|(1[02]))-31)|(((0[1,3-9])|(1[0-2]))-(29|30)))))T(20|21|22|23|[0-1]\\d):[0-5]\\d:[0-5]\\d[\\-,\\+](0[0-9]|10|11|12):00"});
this._dhRegEvento=value } _nProt ; get nProt ( ) { return this._nProt; } set nProt ( value : any ) { TProt(value);
this._nProt=value
 } _chNFePend ; get chNFePend ( ) { return this._chNFePend; } set chNFePend ( value : any ) { TChNFe(value);
this._chNFePend=value
