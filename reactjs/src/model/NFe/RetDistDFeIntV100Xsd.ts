import {TAmb,TVerAplic,TStat,TMotivo,TNSU} from "./TiposDistDFeV100Xsd";
...
this._xMotivo=value
 } _dhResp ; get dhResp ( ) { return this._dhResp; } set dhResp ( value : any ) { undefined } _ultNSU ; get ultNSU ( ) { return this._ultNSU; } set ultNSU ( value : any ) { TNSU(value);
this._ultNSU=value
