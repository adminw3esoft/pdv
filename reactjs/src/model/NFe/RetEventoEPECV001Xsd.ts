import {TAmb,TVerAplic,TStat,TMotivo,TChNFe,TCodUfIBGE,TDateTimeUTC,TProt} from "./TiposBasicoV310Xsd";
...
this._xMotivo=value
 } _retEvento ; get retEvento ( ) { return this._retEvento; } set retEvento ( value : RetEnvEvento_RetEvento ) { this._retEvento=value } _versao ; get versao ( ) { return this._versao; } set versao ( value : any ) { undefined } } export class RetEnvEvento_RetEvento { _infEvento ; get infEvento ( ) { return this._infEvento; } set infEvento ( value : RetEnvEvento_RetEvento_InfEvento ) { this._infEvento=value } _undefined ; get undefined ( ) { return this._undefined; } set undefined ( value : any ) { undefined } _versao ; get versao ( ) { return this._versao; } set versao ( value : any ) { undefined } } export class RetEnvEvento_RetEvento_InfEvento { _tpAmb ; get tpAmb ( ) { return this._tpAmb; } set tpAmb ( value : any ) { TAmb(value);
this._tpAmb=value
 } _verAplic ; get verAplic ( ) { return this._verAplic; } set verAplic ( value : any ) { TVerAplic(value);
this._verAplic=value
 } _cOrgao ; get cOrgao ( ) { return this._cOrgao; } set cOrgao ( value : any ) { TCOrgaoIBGE(value);
...
this._nSeqEvento=value } _cOrgaoAutor ; get cOrgaoAutor ( ) { return this._cOrgaoAutor; } set cOrgaoAutor ( value : any ) { TCodUfIBGE(value);
this._cOrgaoAutor=value
 } _dhRegEvento ; get dhRegEvento ( ) { return this._dhRegEvento; } set dhRegEvento ( value : any ) { TDateTimeUTC(value);
...
this._chNFePend=value
 } _Id ; get Id ( ) { return this._Id; } set Id ( value : any ) { validate(value,{});
this._Id=value } } 