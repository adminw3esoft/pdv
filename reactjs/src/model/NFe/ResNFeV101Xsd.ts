import {TChNFe,TCnpj,TCpf,TIe,TDateTimeUTC,TDec_1302,TProt} from "./TiposDistDFeV101Xsd";
import { validate } from "../../Model" ; /* --------
  This is a generated file. All edits will be overwritten! 
-------- */

export const TVerResNFe = function ( value : any ) { validate(value,{"whiteSpace":"preserve","enumeration":["1.01"]}); } 
...
this._nProt=value
 } _cSitNFe ; get cSitNFe ( ) { return this._cSitNFe; } set cSitNFe ( value : any ) { validate(value,{"whiteSpace":"preserve","enumeration":["1","2","3"]});
