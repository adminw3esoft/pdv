import {TCOrgaoIBGE,TCnpj,TCpf,TChNFe,TDateTimeUTC,TProt} from "./TiposDistDFeV101Xsd";
import { validate } from "../../Model" ; /* --------
  This is a generated file. All edits will be overwritten! 
-------- */

export const TVerResEvento = function ( value : any ) { validate(value,{"whiteSpace":"preserve","enumeration":["1.01"]}); } 
