import {TAmb,TCodUfIBGE,TVerAplic,TStat,TMotivo,TDateTimeUTC,TMed} from "./TiposBasicoV310Xsd";
import { validate } from "../../Model" ; /* --------
  This is a generated file. All edits will be overwritten! 
-------- */

export const TVerConsStatServ = function ( value : any ) { validate(value,{"pattern":"3\\.10"}); } export class TConsStatServ { _tpAmb ; get tpAmb ( ) { return this._tpAmb; } set tpAmb ( value : any ) { TAmb(value);
this._tpAmb=value
