import {TAmb,TChNFe,TVerAplic,TStat,TMotivo,TCodUfIBGE,TDateTimeUTC,TProt,TCOrgaoIBGE,TCnpjOpc,TCpf} from "./TiposBasicoV310Xsd";
...
export const TVerConsSitNFe = function ( value : any ) { validate(value,{"whiteSpace":"preserve","enumeration":["3.10"]}); } export class TConsSitNFe { _tpAmb ; get tpAmb ( ) { return this._tpAmb; } set tpAmb ( value : any ) { TAmb(value);
this._tpAmb=value
